...
namespace CSCore.Ffmpeg
{
    ...
    /// </remarks>
    public class FfmpegIndexedStreamDecoder : IWaveSource
    {
        ...
        public FfmpegIndexedStreamDecoder(string url, int streamIndex)
        {
            _uri = new Uri(url);
            _formatContext = new AvFormatContext(url, streamIndex);
            Initialize();
        }
